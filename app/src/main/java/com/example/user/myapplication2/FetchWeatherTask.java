...
import com.example.user.myapplication2.data.WeatherContract;
import com.example.user.myapplication2.data.WeatherDbHelper;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString("temp_units","celsius"
                );
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        cursor=resolver.query(WeatherContract.LocationEntry.CONTENT_URI,
                              columns,
        ...
        if(cursor.moveToFirst()){
            return  cursor.getLong(cursor.getColumnIndex(WeatherContract.LocationEntry.COLUMN_CITY_NAME));
        }
